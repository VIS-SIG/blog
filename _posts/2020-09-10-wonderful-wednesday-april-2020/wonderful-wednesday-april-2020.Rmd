...
description: |
  Survival dataset. This month’s challenge involved a classic survival dataset example. This simulated example dataset was based on a phase III clinical trial in breast cancer.
author:
  - name: Steve Mallett
