...
In this bar plot, the relatively complex data set is boiled down to a very simple visualization. The relative amount of time is plotted against the time, separately by the treatment groups.

The panel liked its simplicity and that clutter has been avoided. Furthermore, the coloring is chosen in a sensible way. Grey is used for SOC whereas different shaded of green are used for the Rx treatments wich increasing intensity with higher dose levels.
